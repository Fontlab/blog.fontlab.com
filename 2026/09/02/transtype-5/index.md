...
Previously, web output meant WOFF plus EOT. Some browsers supported one, some used the other. But for many years now, WOFF2 is the one format supported by all current browsers.
...
[Get TransType 5 lifetime license for €$ 99 →](https://fontlab.com/buys/tr5)

Have an older TransType? **[Upgrade now](https://fontlab.com/buys/tr5) for €$ 40** (short-term offer!), or later for €$ 50. Bought TransType 4 in 2026? Your upgrade to TransType 5 is free!
