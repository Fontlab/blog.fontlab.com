...
DTL OTMaster 5.0, vfb2ufo, FontLab Pad 1.1
December 2014 This month, we have an exciting major upgrade and two brand-new free tools for Windows and Mac OS X:

DTL OTMaster 5.0, a brand-new version of the technical OpenType font editor (upgrade from older versions for EUR 50)
vfb2ufo, a free command-line tool for two-way conversion between UFO and VFB files
FontLab Pad 1.1, our free color font typesetter.
...
Matthew Carter webinar
 Feb 2014: Matthew Carter is arguably the foremost living type designer of our time...
...
Announcing TransType 4

December 2013 INTRODUCING TransType 4 for Mac and Windows, an easy application to convert, fix, organize and customize fonts. Convert virtually any font (including VFB and UFO) into modern OpenType PS (.otf)/TT (.ttf) fonts and @font-face web fonts. Fix and reorganize family naming problems automatically and through drag-and-drop. Create multi-color OpenType fonts from layered fonts or BitFonter Photofont files. Apply cool special effects to your fonts.
...
NEW! FontLab Studio 5.2.1 for Windows with new features (create OpenType fonts with up to 65,535 glyphs, improved OpenType generation through FEA syntax 2.5, interpolated nodes, OpenType Layout features in Metrics Window, class kerning overlay preview, new Change Weight and Clean Up Paths operations, MM glyph blend preview, canvas notes, Python 2.7, improved user interface) and hundreds of bugfixes. Free upgrade for all Windows users of FontLab Studio 5 and AsiaFont Studio. Download today!

--------------------

Nov 2012 Brand-new FontLab Studio 5.2 Win, new FontLab Studio 5.1.3 Mac
