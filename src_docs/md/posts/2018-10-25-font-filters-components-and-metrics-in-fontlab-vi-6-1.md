---
this_file: src_docs/md/posts/2018-10-25-font-filters-components-and-metrics-in-fontlab-vi-6-1.md
title: "Font filters, components and glyph metrics in FontLab VI 6.1"
authors: [fontlab]
date:
  created: 2018-10-25
slug: font-filters-components-and-metrics-in-fontlab-vi-6-1
review:
  cta_status: ok
  ...
  facts_to_verify:
    - "Basics encodings: New font = 157 glyphs, Latin Simple = 231, Latin Pro = 374 — verify counts"
    - "Real standards-compliant Components introduced in 6.1, replacing simulated components via Element References — verify"
    - "Metrics expressions use the muParser library for conditional and statistical functions — verify"
  image_status: missing
  image_needs: "Screenshot of the Font window Sidebar showing Basics/Categories/Scripts filter sections; and a glyph (e.g. imacron) with a nonspacing macron component highlighted in the Elements panel."
  weakness_verdict: keep
  consolidate_with: "2018-10-25-fontlab-vi-61 — same release, this is the feature deep-dive"
  notes: "Long deep-dive complementing the 6.1 release post. Three big themes: real Components vs Element References, the Font window Sidebar/filters, nonspacing components, and metrics expressions. Preserved the technical detail and concrete examples (imacron/macron, =H, conditional expressions)."
---
