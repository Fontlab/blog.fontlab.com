...
---
![](../media/illu/from-multiple-master-to-variable-1.png){.illu-thumb .illu-index}
...
Adobe announced **Multiple Master** in 1991. Myriad MM had four masters — light/black ×
condensed/extended — and let you interpolate any instance in between.
...
drives full of files named things like `MinioMM_578 BD 465 CN 11 OP`. The last MM
release was 1999.

Apple shipped its own answer the same year, inside QuickDraw GX: **TrueType GX
Variations**. Same idea, different table layout.
It worked. It also lost, mostly because GX as a whole lost.
...
FontLab Ltd was inside the working group pushing for it, and shipped support in FontLab
VI when the spec landed.
...
The instance names are in `fvar`. Nothing lives on the hard drive that didn’t need to be
generated.
