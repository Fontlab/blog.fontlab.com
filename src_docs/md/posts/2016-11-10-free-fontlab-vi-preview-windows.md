---
this_file: src_docs/md/posts/2016-11-10-free-fontlab-vi-preview-windows.md
title: "Free FontLab VI Public Preview for Windows"
authors: [fontlab]
date:
  created: 2016-11-10
slug: free-fontlab-vi-preview-windows
review:
  cta_status: ok
  ...
  facts_to_verify:
    - "Windows Public Preview is a 32-bit app running on Windows XP through Windows 10 (tested on XP, 7, 10) — verify"
    - "FontLab VI supports Unicode 9 and OpenType 1.8, including color and variable fonts — verify"
    - "This build can open variable fonts but not yet generate them — verify"
  image_status: missing
  image_needs: "FontLab VI on Windows: Glyph window and multi-glyph editing screenshots"
  weakness_verdict: keep
  consolidate_with: ""
  notes: "First Windows preview. Stripped 'font editor of tomorrow' hype, expiry urgency, sign-up/download buttons, and forum links; kept the platform facts, feature overview, and the Windows-specific Meta-key caveat."
---
