...
Installing a font to try it is a small tax you pay every time. The app you want to use it in may not see the new font until you quit and reopen it. If you already own three fonts called *Garamond*, your system will quietly show you one of them and hide the rest, with no error and no note about which one you got. And if you keep saying yes to every font you download, you end up with 5,000 of them installed, at which point even a fast machine starts to think about it.

None of that has to happen. With FontLab Pad 2 you open the font file where it lies, type your text, choose the instance you want, insert a variant glyph if the design has one, then copy the result as PDF, SVG or Bitmap and paste it into Figma, PowerPoint, Keynote, or really anything else you work in. The font never touches your system, and your font menus stay as short as you like them.
