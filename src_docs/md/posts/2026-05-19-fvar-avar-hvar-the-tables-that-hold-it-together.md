---
this_file: src_docs/md/posts/2026-05-19-fvar-avar-hvar-the-tables-that-hold-it-together.md
...
It's an OpenType file with a few extra tables nailed on, and once you know what each
one does, the whole thing stops being magic.
...
**`MVAR`** covers font-wide metric variations — cap height, x-height, line gap —
that need to shift as axes change.
...
All of this was announced at ATypI Warsaw in September 2016 — Adobe, Apple, Google,
and Microsoft on the same stage.
