---
this_file: src_docs/md/posts/2019-01-24-sketch-to-font-scanfont.md
title: "From sketch to font in minutes with built-in ScanFont"
authors: [fontlab]
date:
  created: 2019-01-24
slug: sketch-to-font-scanfont
review:
  cta_status: ok
  ...
  facts_to_verify:
    - "Video has over 40,000 views — verify current view count on YouTube"
    - "ScanFont was previously a separate app before being integrated into FontLab VI — verify"
    - "Image tracing workflow further refined in FontLab 7 and 8 — verify"
  image_status: present
  image_needs: "Thumbnail present (fontlabtv-c0XCxcJY_UY.jpg) — adequate"
...
---
![](../media/illu/sketch-to-font-scanfont-1.png){.illu-thumb .illu-index}
...
[![From Sketch to Font in Minutes with Built-in ScanFont](../media/fontlabtv-c0XCxcJY_UY.jpg)](https://www.youtube.com/watch?v=c0XCxcJY_UY)
