...
<figure class="aligncenter"> <img src="/media/external/cloudinary-fls5-fog5-tt3.png" class="wp-image-2314" decoding="async" /> <figcaption>FontLab Studio 5, Fontographer 5, TypeTool 3 on macOS Catalina</figcaption> </figure>
...
<figure class="wp-block-image size-large"> <img src="/media/external/cloudinary-fontlab-studio5-win-crossover19-macos-catalina.png" decoding="async" /> </figure>
