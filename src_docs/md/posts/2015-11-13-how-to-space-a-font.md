...
review:
  ...
  facts_to_verify:
    - "Tutorial runtime 53 minutes — verify against YouTube"
    - "Thomas Phinney described as having 'decades of experience' — verify credentials are still accurate"
    - "Principles apply 'unchanged to FontLab 8' — verify no spacing workflow changes in FL8"
  image_status: present
  image_needs: "Thumbnail present (fontlabtv-tbc_O7bNROs.jpg) — adequate"
